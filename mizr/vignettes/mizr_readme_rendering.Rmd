---
title: "MIg analyZeR (mizr) README Rendering"
author: "NIST MIZR Team"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{MIg analyZeR (mizr) README Rendering}
...
This file renders the code from the examples in the README.md, both the *Installation Check* and the *Quick Run of Select Plots*.
...
# README Rendering: Installation Check

```{r install_check_code}
...
# README Rendering: Quick Run of Select Plots
