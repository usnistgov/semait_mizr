...
$$dpr = \min\left(\frac{\text{percentage males positive class}}{\text{percentage females positive class}},\frac{\text{percentage females positive class}}{\text{percentage males positive class}}\right)$$. 
...
```{r ten_step_block, fig.height=16, fig.width=22}
...
```{r rank_plot_system, fig.height=16, fig.width=19}
...
```{r rank_plot_metrics, fig.height=16, fig.width=19}
...
```{r rank_plot_datasets, fig.height=16, fig.width=19}
